...
const Login = () => {
    const { signInUsingGoogle, signInUsingGithub, user, handleSignInUser } = useAuth();
    ...
    return (
        <div className='mx-auto w-5/6 md:w-2/6 mt-28'>
            <div className=''>
                ...
                <form onSubmit={handleLogin} className='mt-10'>
                    ...
                    <input type="password"
                        ...
                        className='focus:outline-none border-2 px-3 py-1 w-full mb-1' />
                    <input type="submit" value="Log In" className='w-full px-3 py-1 uppercase hover:bg-indigo-500 hover:text-white mt-3' />
                </form>
            </div>
            <div>
            ...
            <div className='mt-3'>Don't have account? <NavLink to="/signup" className="text-indigo-500">Signup</NavLink> here.</div>
        </div>
    )
}
